...
public class Highscores extends AbstractTableModel implements Serializable{
     ...
     */
    ArrayList<bubble_shooter.HighscoreEntry> entries = new ArrayList<bubble_shooter.HighscoreEntry>();
...
public Object getValueAt(int row, int col) {
    bubble_shooter.HighscoreEntry entry = entries.get(row);
    switch (col) {
 ...
 */
public void addEntry(bubble_shooter.HighscoreEntry e){
    entries.add(e);
...
public void readObject(ObjectInputStream o) throws IOException, ClassNotFoundException{
    entries = (ArrayList<bubble_shooter.HighscoreEntry>) o.readObject();
}
     ...
     */
    public void print(){
        for (bubble_shooter.HighscoreEntry h : entries){
